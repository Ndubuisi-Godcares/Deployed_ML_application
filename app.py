...
s_length = st.slider('Sepal Length', 0, 15, 2, step=1)
s_width = st.slider('Sepal Width', 0, 15, 2, step=1)
p_length = st.slider('Petal Length', 0, 15, 2, step=1)
p_width = st.slider('Petal Width', 0, 15, 2, step=1)
